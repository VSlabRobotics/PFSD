# lyt: deal with the dataset made by us
...
lyt = \
    ['2', '4', '5', '6', '7', '9', '10', '11', '12', '13', '14', '15', '16', '17', '19', '20',
     '21', '22',
     # '23',
     '24', '25', '28', '29', '31', '33', '39',
     '43', '47', '52', '53',  '55', '56',
     '59', '62', '63', '64', '71', '74', '76', '77',
     '78', '79', '82', '84']
...
# 计算划分索引
train_split = int(len(lyt) * train_ratio)
val_split = int(len(lyt) * (train_ratio + val_ratio))

# 划分数据集
train = lyt[:train_split]
val = lyt[train_split:val_split]
test = lyt[val_split:]


# 原本有train_detect + train_track，暂时为分
train_detect = copy.deepcopy(train)
train_track = copy.deepcopy(train)

# mini也是很简单的处理了
mini_train = copy.deepcopy(train + val)
mini_val = copy.deepcopy(test)

# mini_train.append('4')    # 一开始用2测试，调整数据格式前的测试
# mini_train.append('5')    # 一开始用2测试，调整数据格式前的测试
#
# # 3/21/2024用于测试
# mini_train = ['2']
# mini_val = ['4']
...
# 随机产生可能会在一个程序内多次调用的时候出现问题，所以自己指定
train =   ['2', '4',  '7', '9', '10', '12', '13', '14', '16', '17', '19',
     '21', '22',
     # '23',
     '24', '25', '29', '33', '39',
     '47', '52', '53',  '56',
     '59', '62', '63',  '74', '76',
     '79', '82', '84']
val = ['5', '11', '20', '31', '64', '78']
test = ['6', '15', '28', '43', '55', '71', '77']


# 原本有train_detect + train_track，暂时为分
train_detect = copy.deepcopy(train)
train_track = copy.deepcopy(train)  # lyt
...
def create_splits_scenes(verbose: bool = False) -> Dict[str, List[str]]:
    ...
    # assert len(all_scenes) == 1000 and len(set(all_scenes)) == 1000, 'Error: Splits incomplete!'  # lyt
    assert len(all_scenes) == 43 and len(set(all_scenes)) == 43, 'Error: Splits incomplete!'
