...
class Detector3DTemplate(nn.Module):
    ...
    def build_networks(self):
        model_info_dict = {
            ...
            'grid_sizes': self.dataset.grid_sizes, 
            'point_cloud_range': self.dataset.point_cloud_range,
            # 'voxel_size': self.dataset.voxel_size,  
            'voxel_sizes': self.dataset.voxel_sizes, 
    ...
    def build_vfe(self, model_info_dict):
        ...
        vfe_module = vfe.__all__[self.model_cfg.VFE.NAME](
            ...
            voxel_sizes=model_info_dict['voxel_sizes'], 
            # grid_size=model_info_dict['grid_size'],    
            grid_sizes=model_info_dict['grid_sizes'],
    ...
    def build_dense_head(self, model_info_dict):
        ...
        dense_head_module = dense_heads.__all__[self.model_cfg.DENSE_HEAD.NAME](
            ...
            # grid_size=model_info_dict['grid_size'],
            # grid_sizes=model_info_dict['grid_sizes'],  
            grid_size=model_info_dict['grid_sizes'][0],  
            point_cloud_range=model_info_dict['point_cloud_range'],
            predict_boxes_when_training=self.model_cfg.get('ROI_HEAD', False),
            # voxel_size=model_info_dict.get('voxel_size', False)    
            # voxel_sizes=model_info_dict.get('voxel_sizes', False)  
            voxel_size=model_info_dict.get('voxel_sizes', False)[0] 
        )
